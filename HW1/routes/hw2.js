...
db.on('error', console.error.bind(console, 'Connection Error oops:'));
db.once('open', function () {
    console.log('Successful Connection Ya!!.')
...
const StringParam = mongoose.model('StringParam', stringSchema);
    ...
    StringParam.findOne({
        ...
        if (err) {
            ...
            if (!string) {
                ...
                const newString = new StringParam({
                    string: namedParameter,
                    length: length
                });
